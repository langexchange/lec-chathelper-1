...
const ChatBox = ModelWithContact.extend({
    ...
    // NOTE: Message after the file uploaded is sent here
    ...
    async sendFiles (files, message_text="") {
        const { __ } = _converse;
