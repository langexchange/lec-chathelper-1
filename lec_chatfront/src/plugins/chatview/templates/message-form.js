...
function tplSendButton() {
  ...
  return html`<button type="submit" class="btn send-button send-button-custome" title="${i18n_send_message}">
...
export default (o) => {
  ...
  return html`
        <div class="textarea-container-custom">
...
${o.message_value || ""}</textarea
    ...
    show_send_button ? tplSendButton() : ""
  }</div>
        </div>
    `;
};
